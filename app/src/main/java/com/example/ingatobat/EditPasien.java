...
public class EditPasien extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextUsia = findViewById(R.id.edit_usia); // Make sure this matches your layout
        ...
        // Handle EditText Usia click (if necessary)
        editTextUsia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Handle any necessary actions on click
            }
        });

        // Handle ImageButton click to go back
        ...
        // Handle button click to edit pasien data
        buttonEditPasien.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                updatePasien();
            }
    ...
    private void tampilkanDataPasien(int id) {
        ...
        if (pasien != null) {
            ...
            editTextUsia.setText(String.valueOf(pasien.getUsia())); // Make sure to convert int to String
            ...
            // Handle case where no pasien found with given ID
    ...
    private void updatePasien() {
        ...
        int usia = Integer.parseInt(editTextUsia.getText().toString().trim()); // Convert EditText to int
        ...
        // Validate input
        if (nama.isEmpty() || riwayatPenyakit.isEmpty()) {
